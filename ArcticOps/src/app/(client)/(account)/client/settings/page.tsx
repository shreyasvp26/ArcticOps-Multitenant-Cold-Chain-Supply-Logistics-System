...
import {
  Bell, Shield, Palette, Globe, ChevronRight, Key,
} from "lucide-react"
...
const SETTING_GROUPS = [
  ...
  },
  {
    ...
    color: "#FFA502",
    items: [
      { label: "Alert Preferences", desc: "Temperature, delay, and shipment alerts" },
  ...
  },
  {
    ...
    color: "#00C8A8",
    items: [
      { label: "Timezone & Units", desc: "Localise dates, weights, and temperatures" },
      { label: "Language", desc: "Interface display language" },
    ],
  },
  {
    title: "Appearance",
    ...
    color: "#06B6D4",
    items: [
      { label: "Theme & Display", desc: "Density, accent colour, font size" },
    ],
  },
]
    ...
    >
      <div className="flex items-center gap-3 mb-2">
        ...
        <div>
          ...
          <p className="text-[12px]" style={{ color: "var(--ao-text-muted)", fontFamily: "var(--ao-font-body)" }}>Manage your preferences and account</p>
        </div>
      </div>
